# ./R/study-functions.R
# Set of R scripts saved in the R folder, these scripts are functions from original
# R scripts. Each of these functions will become a different target.

## 1-2. Function to read in and pre-processing data
